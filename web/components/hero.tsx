    ...
    <section className="flex flex-col items-center px-6 pt-24 pb-20 md:pt-[180px]">
      ...
      <Reveal delay={450} className="flex flex-col items-center">
        ...
        <p className="mt-4 max-w-[620px] text-center text-sm text-pretty text-fg-3">
          ...
          {spreadF.toFixed(1)} °F at the same minute</b>. Your building automation system gets one
      ...
      <Reveal delay={560} className="flex w-full justify-center">
        <div
          className="mt-16 w-full max-w-[1120px] rounded-2xl border border-line bg-surface p-2"
          role="img"
